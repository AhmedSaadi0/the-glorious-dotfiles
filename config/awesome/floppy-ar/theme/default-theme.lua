...
local awesome_overrides = function(theme)
	...
	-- Tasklist
	theme.tasklist_font = 'JF Flat 10'
	...
	-- Hotkey popup
	theme.hotkeys_font = 'JF Flat'
	theme.hotkeys_description_font   = 'JF Flat '
